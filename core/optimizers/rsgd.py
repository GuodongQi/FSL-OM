...
from core.manifolds import Euclidean, ManifoldParameter
from core.optimizers.radam import OptimMixin, copy_or_set_, _default_manifold
        ...
        for p in group["params"]:
            ...
            if momentum > 0:
                ...
                if "momentum_buffer" in param_state:
                    ...
                    buf.set_(manifold.proj_tan(buf, p))
